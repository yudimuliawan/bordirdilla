						...
						<div class="box">
							<div class="panel panel-info">
								<div class="panel-heading">
									<h3 class="panel-title">Data Produk Sepatu Bordir.ID</h3>
								</div>
								<div class="panel-body">
									<div class="row">
										<div class="col col-xs-12 text-right">
											<a class="btn btn-sm btn-primary" href="/product/create" style="color: white; text-decoration: none;">Create New Product</a>
											<a class="btn btn-sm btn-warning" href="/category" style="color: white; text-decoration: none;">Category</a>
										...
										<tbody>
											@foreach($products as $product)
												<tr>
													...
													<td>{{$product->price}}</td>
													<td style="width: 20%;"><img src="{{asset('vendor/colo/images/product_5.png') }}" style="height: 20%; width: 20%;"></td>
								...
								<div class="panel-footer">
									<div class="row">
										<div class="col col-xs-4">Number of product(s) count: {{$products->count()}}</div>
									</div>
	                			</div>
	              			</div>
	            		</div>
